...
public class Utility {
     ...
     */
    public static int getBnwIconResourceForWeatherCondition(int weatherId) {
     ...
     */
    public static int getColorIconForWeatherCondition(int weatherId) {
        // Based on weather code data found at:
        // http://bugs.openweathermap.org/projects/api/wiki/Weather_Condition_Codes
        if (weatherId >= 200 && weatherId <= 232) {
...
//        return String.format("%.0f", temp);
        //filled the string with the format given in the String.xml
