...
public class WeatherProvider extends ContentProvider {
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            // input the type of the return mine type defined in the contract.
            // The important thing is to understand from which entry, multi or single result
            // as it's been designed in the contract for the app
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        //need to use the uri, not the returnUri here
        getContext().getContentResolver().notifyChange(uri, null);

        //remember to close the db after write
        db.close();
        return returnUri;
    }
